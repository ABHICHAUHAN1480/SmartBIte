  ...
  return (
    <div className="relative  min-h-screen w-full overflow-hidden font-serif">
      <div className=' bg-zinc-950  h-screen flex'>
        <img className=' absolute  w-full opacity-30' src={oip} />
        <div className=' m-auto z-10 div1 bg-opacity-70 rounded-2xl bg-zinc-900   ' >
          <div className='text-[55px] text-center mt-16 '>Allergy hai to btade abhi hi </div>
          <div className='flex flex-col justify-around mt-32  gap-11 items-center '>
           <div className='w-1/2 '>  <input onChange={handleChange} className=' w-8/12  mr-16 py-2  px-4 text-slate-50 rounded-2xl   bg-black bg-opacity-35' placeholder='Search' value={form.search} name='search' /><button onClick={handleSave} className='py-2 px-6 bg-blue-700 rounded-3xl hover:border'>Save</button></div>
